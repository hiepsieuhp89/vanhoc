...
EOD;
		...
		<div class="panel-footer text-right">
			<a href="trangchu.php?top=banchay&c=Sach&act=DanhSach" class="btn btn-danger">Xem thêm sách bán chạy</a>
		</div>
	</div>
...
EOD;
		...
		<div class="panel-footer text-right">
			<a href="trangchu.php?top=moixb&c=Sach&act=DanhSach" class="btn btn-primary">Xem thêm sách mới xuất bản</a>
		</div>
	</div>
...
EOD;
		...
		<?php
			...
			$footer = <<< EOD
			<div class="panel-footer text-right">
			<a href="trangchu.php?&c=Sach&act=DanhSach&madms={$r['MADMS']}" class="btn btn-default">Xem thêm sách $tendms</a>
		</div>
EOD;
			echo $footer;
		?>
