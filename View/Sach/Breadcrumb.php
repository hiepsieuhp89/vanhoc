				...
				else
				{
					...
					else
					{
						...
						else
						{
							$str1 = <<<EOD
								<li>
									<a href="trangchu.php?c=Sach&act=DanhSach&madms={$result_dms['MADMS']}">{$result_dms['TENDMS']}</a>
								</li>
EOD;
							echo $str1;
							...
							else
							{
								$str2 = <<<EOD
								<li>
									<a href="trangchu.php?c=Sach&act=DanhSach&madms={$result_dms['MADMS']}&maloai={$result_ls['MALOAI']}">{$result_ls['TENLOAI']}</a>
								</li>
EOD;
								echo $str2;
