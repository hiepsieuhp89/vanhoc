	...
	if(isset($_SESSION['TaiKhoan']))
	{
		...
		<div class="dropdown" style="display: inline-block">
			...
			<ul class="dropdown-menu">
				<li><a href="trangchu.php?c=KhachHang&act=ThongTin&makh=$makh"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Thông tin khách hàng</a>
</li>
				<li><a href="trangchu.php?c=KhachHang&act=DonHangDaDat&makh=$makh"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Đơn hàng đã đặt</a>
</li>
			</ul>
		</div>
...
EOD;
	...
	{
		echo '<a href="trangchu.php?c=KhachHang&act=DangNhap" id="DangNhap" class="btn btn-primary"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Đăng nhập</a>';
		echo ' <a href="trangchu.php?c=KhachHang&act=DangKy" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Đăng ký</a>';
	}
?>