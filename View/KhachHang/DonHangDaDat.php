		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				?>
							...
							if ($hd['TRANGTHAI'] == 4) {
								$trangthai = 'Đã hủy bởi người dùng';
							}
							?>
								...
								<div class="panel-body">
									<div class="panel panel-default">
										<div class="panel-body thongtin" style="position:relative;">
											...
											<?php 
												if($hd['TRANGTHAI'] == 0)
													echo '<a style="position:absolute; top:10px; right:10px;" href="trangchu.php?c=HoaDon&act=Huy&t=4&madonhang='.$hd['MAHD'].'&makh='.$_REQUEST['makh'].'" class="btn btn-danger">Hủy đơn</a>';
											?>
										</div>
									</div>
